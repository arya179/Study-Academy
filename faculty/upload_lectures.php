...
if (isset($_POST['upload']) && $_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	if ($fileError!=0) {
		...
		$sql = "INSERT INTO `lectures` (`admin_id`, `faculty_id`, `d_id`, `semester`, `sub_id`, `unit_id`, `topic`, `lecture_link`) VALUES ( NULL,'$faculty_id', '$department', '$semester', '$sub_id', '$unit_id' , '$topic', '$lecture_link')";
			...
			if ($fileError === 0) {
				...
				// $uniqid=rand(10000,99999);
					...
					if ($move) {
						...
						$sql = "INSERT INTO `lectures` (`admin_id`, `d_id`, `semester`, `faculty_id`, `sub_id`,  `unit_id`, `topic`,`lecture_path`) VALUES (NULL, '$department', '$semester' ,'$faculty_id', '$sub_id', '$unit_id' ,  '$topic','$fileDestination')";
...
<body>
		<div class="container bg-white">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="card-title text-lg-center">Upload Lectures : <em class="text-danger"><?php echo d_id($_SESSION['d_id']); ?></em></h3>
				</div>
