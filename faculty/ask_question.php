...
if (isset($_SESSION['d_id']) && isset($_GET['semester']) && $_GET['semester'] != '') {
...
if ($_SERVER['REQUEST_METHOD']=='POST'  and isset($_POST['ask_question_btn']) and isset($_POST['question']) ) {
        ...
        if (isset($_GET['unit_id']) or isset($_POST['unit_id']) ) {
            ...
            $sql="INSERT INTO `ask_question` (`sub_id`,`faculty_id`,`unit_id`,`question`) VALUES('$sub_id', '$faculty_id', '$unit_id', '$question')";
