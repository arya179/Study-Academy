...
if ($_SERVER['REQUEST_METHOD']=='POST'  and isset($_POST['ask_question_btn']) and isset($_POST['question']) ) {
        ...
        if (isset($_GET['unit_id']) or isset($_POST['unit_id']) ) {
            ...
            $sql="INSERT INTO `ask_question` (`sub_id`,`stu_id`,`unit_id`,`question`) VALUES('$sub_id', '$stu_id', '$unit_id', '$question')";
 ...
 <div class="container-fluid">
    ...
    <center>
                    ...
                    if (isset($unitSQL)) {
                        ...
                        <a class="shadow" href="ask_question.php?sub_id='.$sub_id.'&unit_id='.$unitRow['unit_id'].'"><div class="col-sm-11 btn btn-sm btn-warning  my-3">'.$unitArr["unit_number"].'.&nbsp;'.$unitArr["unit_name"].'</div></a> ';
                            } else {
                                echo '<a class="shadow-sm" href="ask_question.php?sub_id='.$sub_id.'&unit_id='.$unitRow['unit_id'].'"><div class="col-sm-11 btn btn-sm btn-primary my-3">'.$unitArr["unit_number"].'.&nbsp;'.$unitArr["unit_name"].'</div></a>';
                            }
