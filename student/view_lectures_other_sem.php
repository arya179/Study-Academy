    ...
    if (mysqli_num_rows($SubSqlResult) == 0) {
        ...
        while ($subRow = mysqli_fetch_assoc($SubSqlResult)) {
            if ($subRow['sub_id'] == $sub_id) {
                echo '<a class="btn btn-success  m-2 my-4" href="view_lectures_other_sem.php?semester=' . $semester . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
            } else {
                echo '<a class="btn btn-secondary  m-2 my-4" href="view_lectures_other_sem.php?semester=' . $semester . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
            }
        }
    }
    ?>
            ...
            <div class="col-sm-3 p-2 ">
                <center>
                    ...
                    if (isset($unitSQL)) {
                        ...
                        <a class="shadow" href="view_lectures_other_sem.php?semester=' . $semester . '&sub_id=' . $sub_id . '&unit_id=' . $unitRow['unit_id'] . '"><div class="col-sm-11 btn btn-sm btn-warning  my-3">' . $unitArr["unit_number"] . '.&nbsp;' . $unitArr["unit_name"] . '</div></a> ';
                            } else {
                                echo '<a class="shadow-sm" href="view_lectures_other_sem.php?semester=' . $semester . '&sub_id=' . $sub_id . '&unit_id=' . $unitRow['unit_id'] . '"><div class="col-sm-11 btn btn-sm btn-primary my-3">' . $unitArr["unit_number"] . '.&nbsp;' . $unitArr["unit_name"] . '</div></a>';
                            }
                        }
                    }
