...
// units change
			...
			// var uploadEditsub_id= <?php  if (isset($sub_id)){echo $sub_id;} ?>
...
<div class="bg-dark my-4 text-white text-center p-2" style="font-size: 12px;">Copyright &#169; <?php echo date('Y'); ?> STUDY-ACADEMY | All Rights Reserved</div>
	</body>
</html>
