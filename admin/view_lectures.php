		...
		<div class="container-fluid mt-3">
			...
			<div class="card ">
				<div class="card-header">
					<h3 class="text-center "><em class="text-primary font-weight-bold text-decoration-underline"><?php echo $semEcho ?></em>&nbsp; <b class="text-decoration-underline text-danger"><?php echo d_id($d_id); ?></b>  &nbsp;<b class=" font-weight-normal text-decoration-underline">Lectures</b></h3>
				</div>
				<center>
					...
					if (isset($subSql)) {
						...
						while ($subRow = mysqli_fetch_assoc($subResult)) {
							...
							if ($subRow['sub_id'] == $sub_id1) {
								...
								echo '<a class="btn btn-secondary  m-2 my-4" href="view_lectures.php?d_id='.$d_id.'&sem_id='.$sem_id.'&sub_id='.$subRow['sub_id'].'">' . sub_id($subRow['sub_id']) . '</a>';
							}
		...
		?>
								<tr>
					                ...
					                $num=mysqli_num_rows(mysqli_query($con,"SELECT * from comments WHERE lec_id={$row['lec_id']}"))
					                 ?>
									<td><span class=""><a href="comments.php?lec_id=<?php echo $row['lec_id']; ?>"><i class="fa fa-comments"></i> <?php echo $num; ?></a></span></td>
									<?php
									...
									<td >
										<a href="edit_lectures.php?lec_id=<?php echo $row['lec_id']; ?>" class="btn  btn-primary" href="">Edit</a>
									</td>
									<td>
