		...
		if (in_array($fileActualExt, $allowed)) {
			...
			if ($fileError === 0) {
				...
				// $uniqid=rand(10000,99999);
					...
					//insert query
					$sql = "INSERT INTO `study_materials` (`admin_id`, `faculty_id`, `d_id`, `semester`, `sub_id`, `unit_id`, `topic`, `file`) VALUES ('$admin_id', NULL, '$department', '$semester', '$sub_id', '$unit_id', '$topic', '$fileDestination')";
