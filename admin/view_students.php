	...
	<div class="card">
		...
		?>
								<tr>
									...
									<td >
										<a href="edit_students.php?enrollment=<?php echo $row['enrollment']; ?>" class="btn  btn-primary" href="">Edit</a>
									</td>
									<td>
										<a href="delete.php?enrollment=<?php echo $row['enrollment']; ?>" class="btn btn-danger" href="">Delete</a>
									</td>
								</tr>
					<?php
							}
